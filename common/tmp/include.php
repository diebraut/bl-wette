...
function getUserResultArray() {
     ...
     $dbLink = mysqli_connect(HOST, DB_USER,DB_PASSWD,'bl_wette');
...
class bl_season {
    ...
    static $ArrIDVerein = array( 
                       ...
                       array('40' ,'1'),  // Bayern München
                       array('9'  ,'9'),  // Schalke 04
                       array('1635' ,'15'), // RB Leibzig
                       array('80' ,'65'),  // 1 FV Union Berlin
                       ...
                       array('81' ,'10'), // FC Mainz
                       array('65','18'),  // 1 FC Köln
                       array('87' ,'4'),  // Borussia M'gladbach
                       array('83' ,'16'),  // Arminia_Bielefeld.
                       //array('31' ,'16'), // SC Paderborn
                       array('16','3'));     // VFP Stuttgart
                       //array('185','3'),  // Düsseldorf
   ...
   function switchToNextSpieltag ( $currentDay ) 
   {
      ...
      $actCurrentGroupId = $currentGroupId;
         ...
         //ermittung des Datum/Zeit vom ersten und letzten Spieles des Spieltages            
 	     foreach ($response->GetMatchdataByGroupLeagueSaisonResult as $matches){
	        foreach ($matches as $match)  {
				if ($actCurrentGroupId !== $currentGroupId || ($actCurrentGroupId === $currentGroupId && $match->matchIsFinished)) {
